...
tf.summary.histogram('Layer 1 Weights', W1)
tf.summary.histogram('Layer 1 Biases', b1)

tf.summary.histogram('Layer 2 Weights', W2)
tf.summary.histogram('Layer 2 Biases', b2)

tf.summary.histogram('Layer 3 Weights', W3)
tf.summary.histogram('Layer 3 Biases', b3)

tf.summary.histogram('Layer 4 Weights', W4)
tf.summary.histogram('Layer 4 Biases', b4)

tf.summary.histogram('Layer 5 Weights', W5)
tf.summary.histogram('Layer 5 Biases', b5)

merged_summary = tf.summary.merge_all()


writer = tf.summary.FileWriter('/Users/jonathanbrink/Desktop/tensorboard/example_nn')
...
with tf.Session() as sess:
    ...
    for i in range(NUM_ITERS+1):
        ...
        if i%DISPLAY_STEP ==0:
            ...
            acc_trn, loss_trn, w, b, summary = sess.run([accuracy, cross_entropy, allweights, allbiases, merged_summary], feed_dict={X: batch_X, Y_: batch_Y, pkeep: 1.0})
